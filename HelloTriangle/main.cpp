...
private:
    ...
    void drawFrame() {
        ...
        // The wait semaphore is used to wait for execution to begin and to indicate
        ...
        // The signal semaphore is signaled when the command buffer execution has completed.
        ...
        // Now that the image has been rendered, we need to submit it back
        // to the swap chain to have it eventually shown on the screen.
